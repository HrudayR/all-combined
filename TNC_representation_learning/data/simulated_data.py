...
def main(n_samples, sig_len):
    ...
    if not os.path.exists('/home/hruday/PycharmProjects/TNC_representation_learning/TNC_representation_learning/data/simulated_data'):
        os.mkdir('/home/hruday/PycharmProjects/TNC_representation_learning/TNC_representation_learning/data/simulated_data')
    with open('/home/hruday/PycharmProjects/TNC_representation_learning/TNC_representation_learning/data/simulated_data/x_train.pkl', 'wb') as f:
        pickle.dump(train_data_n, f)
    with open('/home/hruday/PycharmProjects/TNC_representation_learning/TNC_representation_learning/data/simulated_data/x_test.pkl', 'wb') as f:
        pickle.dump(test_data_n, f)
    with open('/home/hruday/PycharmProjects/TNC_representation_learning/TNC_representation_learning/data/simulated_data/state_train.pkl', 'wb') as f:
        pickle.dump(train_state, f)
    with open('/home/hruday/PycharmProjects/TNC_representation_learning/TNC_representation_learning/data/simulated_data/state_test.pkl', 'wb') as f:
